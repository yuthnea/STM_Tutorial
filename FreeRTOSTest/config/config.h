...
#define RC_TASK_PRI_TEST		3
#define IMU_TASK_PRI_TEST		4
#define QMC_TASK_PRI_TEST		4
#define ATT_TASK_PRI_TEST		4
...
#define RC_TASK_NAME_TEST		"RC_TEST"
#define IMU_TASK_NAME_TEST		"IMU_TEST"
#define QMC_TASK_NAME_TEST		"QMC_TEST"
#define ATT_TASK_NAME_TEST		"ATT_TEST"
...
#define RC_TASK_STACKSIZE			  (2 * configMINIMAL_STACK_SIZE)
#define IMU_TASK_STACKSIZE			  (2 * configMINIMAL_STACK_SIZE)
#define QMC_TASK_STACKSIZE			  (2 * configMINIMAL_STACK_SIZE)
#define ATT_TASK_STACKSIZE			  (2 * configMINIMAL_STACK_SIZE)
